...
struct phytium_psr {
	...
	bool sink_no_train_on_exit;
	bool psr_work_init;
	bool sink_not_reliable;
	int psr_setup_time_us;
	int sink_status_error_count;
	...
	ktime_t enabled_psr_time;
	ktime_t disabled_psr_time;
};
...
struct phytium_dp_device {
	...
	struct delayed_work edp_delay_on_work;
	bool edp_delay_on_work_pending;

	bool dp_power_enable_status;
	bool i2s_control_switch;
	bool i2s_control_not_exit;
	int custom_delay_ms;
